...
var file_proto_keeper_v1_notification_proto_rawDesc = []byte{
	...
	0x69, 0x62, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x56, 0x31, 0x30, 0x01, 0x42,
...
var file_proto_keeper_v1_notification_proto_goTypes = []any{
	...
	(*SubscribeResponseV1)(nil), // 1: proto.keeper.v1.SubscribeResponseV1
}
var file_proto_keeper_v1_notification_proto_depIdxs = []int32{
	...
	1, // 1: proto.keeper.v1.NotificationService.SubscribeV1:output_type -> proto.keeper.v1.SubscribeResponseV1
...
func file_proto_keeper_v1_notification_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_keeper_v1_notification_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*SubscribeResponseV1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
