...
var File_proto_keeper_v1_auth_proto protoreflect.FileDescriptor

var file_proto_keeper_v1_auth_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x2f, 0x76,
	0x31, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x70, 0x72,
...
var (
	file_proto_keeper_v1_auth_proto_rawDescOnce sync.Once
	file_proto_keeper_v1_auth_proto_rawDescData = file_proto_keeper_v1_auth_proto_rawDesc
)

func file_proto_keeper_v1_auth_proto_rawDescGZIP() []byte {
	file_proto_keeper_v1_auth_proto_rawDescOnce.Do(func() {
		file_proto_keeper_v1_auth_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_keeper_v1_auth_proto_rawDescData)
	})
	return file_proto_keeper_v1_auth_proto_rawDescData
}
...
func init() { file_proto_keeper_v1_auth_proto_init() }
func file_proto_keeper_v1_auth_proto_init() {
	if File_proto_keeper_v1_auth_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_keeper_v1_auth_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_keeper_v1_auth_proto_goTypes,
		DependencyIndexes: file_proto_keeper_v1_auth_proto_depIdxs,
		MessageInfos:      file_proto_keeper_v1_auth_proto_msgTypes,
	}.Build()
	File_proto_keeper_v1_auth_proto = out.File
	file_proto_keeper_v1_auth_proto_rawDesc = nil
	file_proto_keeper_v1_auth_proto_goTypes = nil
	file_proto_keeper_v1_auth_proto_depIdxs = nil
}
